...
const ModalUbahLoker = () => {
  return (
    <div className="modal fade" id="ubah-loker" style={{display: 'none'}} aria-hidden="true">
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title">Ubah Informasi Lowongan Kerja</h4>
              ...
              <div className="col-md-12">
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    // placeholder="NISN" 
                    // name='nisn'
                    value='Lowongan Kerja HRD – REKRUTMEN & TRAINER'
                  />

...
const ModalTambahPelatihan = () => {
  return (
    <div className="modal fade" id="tambah-pelatihan" style={{display: 'none'}} aria-hidden="true">
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title">Tambah Pelatihan</h4>
...
export default ModalTambahPelatihan

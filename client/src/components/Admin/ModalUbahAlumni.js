...
const ModalUbahAlumni = ({
  ...
  return (
    <div className="modal fade" id="ubah" style={{display: 'none'}} aria-hidden="true">
              ...
              <div className="col-md-6">
                ...
                <Form.Group>
                  ...
                  <Form.Control 
                    ...
                    name='tanggal_lahir'
                    value={formatDate(dataAlumni.tanggal_lahir)}
                    // value={moment(dataAlumni.tanggal_lahir)}
                  />
                  <Form.Control.Feedback type="invalid">

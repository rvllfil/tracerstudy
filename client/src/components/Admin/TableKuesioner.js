      ...
      <div className="col-12">
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">Data Kuesioner Alumni</h3>
          ...
          <div className="card-body table-responsive p-0">
            <table className="table table-hover text-nowrap">
              <thead>
                <tr>
                  <th>Status</th>
                  <th>Nama Perusahaan Tempat Bekerja</th>
                  <th>Alamat Perusahaan</th>
                  <th>Pekerjaan Sesuai dengan Jurusan saat Sekolah</th>
                  <th>Gaji</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return ( */}
                    <>
                      ...
                      data-widget='expandable-table' aria-expanded='false'>
                        <td>Bekerja</td>
                        <td className='text-capitalize'>PT. Astra</td>
                      ...
                      data-widget='expandable-table' aria-expanded='false'>
                        <td>Bekerja</td>
                        <td className='text-capitalize'>PT. Sarandi</td>
                        <td>Sukabumi</td>
                        <td>Tidak</td>
